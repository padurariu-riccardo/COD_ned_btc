...
public class BackAndForth extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
      ...
      //  ImuSubsystem imuSubsystem=new ImuSubsystem(hardwareMap);
        ...
        waitForStart();
       // imuSubsystem.startIMUThread(this);
        while (opModeIsActive() && !isStopRequested()) {
            drive.followTrajectory(trajectoryForward);
            drive.followTrajectory(trajectoryBackward);
           // SampleMecanumDrive.angleFromModule = imuSubsystem.imuAngle;
           // SampleMecanumDrive.velocityFromModule = imuSubsystem.imuVelocity;
        }
    }
}